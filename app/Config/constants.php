...
//Gmail SMTP
define("SMTP_HOST", "192.168.237.70");
define("SMTP_PORT", "25");
define("SMTP_UNAME", "breeonad@sminc.net");
define("SMTP_PWORD", "sunbelt1!");
define("IS_SMTP", "1");
...
define('FROM_EMAIL_NOTIFY', 'breeonad@sminc.net'); //(REQUIRED)
define('SUPPORT_EMAIL', 'breeonad@sminc.net'); //(REQUIRED) From Email
...
define('SUB_FOLDER', 'orangescrum-master/'); //If your application URL followed by a folder name like: http://your-site.com/folder_name, put your folder name as 'folder_name/'
